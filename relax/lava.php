   ...
   <head>
    ...
    <div style="width:1000px color:white">
        <!-- <img src="../images/lavaFlow.png" alt="4thGame" style="width:100%; height:70%; "> -->
          <div class="audioPlayer" style="width:3rem;height:3rem;position: absolute;top: 4rem; left: 0rem">
              <div data-video="LnlvsB_NNL4" data-autoplay="0" data-loop="1" id="youtube-audio1">
              </div>
          </div>
        </img>
        ...
        <script type="text/javascript" src="lava.js" overflow-y="scroll"></script>
    </div>
      <style>
        body, html {
          background-position:center;
          background-image: url("../images/lavaFlow.png");
