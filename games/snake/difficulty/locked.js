...
const backgroundC = urlParams.get("background");
const wallsC = urlParams.get("walls");

window.onload = function() {
  document.getElementById("game-area").style.backgroundColor = backgroundC;
};
...
$(document).ready(function() {
  ...
  var mediumDifficulty = 5;
  var hardDifficulty = 10;
  var maxedDifficulty = 15;
  ...
  let currentPlayerDir = playerDir["down"];
  ...
  function playerEatsPoint() {
    ...
    do {
      ...
      for (let i = 0; i < rectangleList.length; i++) {
        ...
        // Do not allow to spawn food under snake either
        else if (
          $(".tr" + pointPosX + "td" + pointPosY).hasClass("draw-player")
        ) {
          newSpawn = true;
        }
      }
  ...
  function checkForWallSpawn() {
    ...
    if (gameScore == easyDifficulty) {
      ...
      let rand4 = rand();
      rectangleList.push(
        new Rectangle(2, 8, 2, 3),
        new Rectangle(2, 3, 3, 8),
        new Rectangle(11, 17, 16, 17),
        new Rectangle(16, 17, 11, 17),
        new Rectangle(rand1, rand1, rand2, rand2),
        new Rectangle(rand3, rand3, rand4, rand4)
      ); // x1 x2 y1 y2
    ...
    if (gameScore == mediumDifficulty) {
      ...
      let rand4 = rand();
      rectangleList.push(
        new Rectangle(3, 6, 16, 16),
        new Rectangle(3, 3, 13, 15),
        new Rectangle(16, 16, 2, 6),
        new Rectangle(12, 15, 2, 2),
        new Rectangle(rand1, rand1, rand2, rand2),
        new Rectangle(rand3, rand3, rand4, rand4)
      );
    ...
    if (gameScore == maxedDifficulty) {
      ...
      rectangleList.push(
        ...
        new Rectangle(19, 19, 14, 19),
        new Rectangle(14, 19, 19, 19),
        new Rectangle(13, 13, 12, 13),
      ...
      if (
        ...
        if (playerIsDead == false) {
          ...
          document.querySelector(".endgame .text").innerText =
            "Thank you for playing, on this exlusive map!";
          highscores();
        }
        playerIsDead = true;
      }
  ...
  function highscores() {
    ...
    if (U_UID == "false") {
      document.getElementById("highscoreTable").innerHTML =
        "Please log in on Foxdrop to see the highscores for this exclusive game mode!";
    } else {
      var highscoreForm = new FormData();

      highscoreForm.append("username", U_UID);
      highscoreForm.append("user_score", gameScore);
      highscoreForm.append("game", "snakeExclusive");
